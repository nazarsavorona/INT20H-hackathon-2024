...
def get_binary_predictions(binary_model, img_paths, batch_size):
    ...
    df = pd.DataFrame({"patientId": img_ids, "pneumonia": probs})

    return df


# TODO: Implement get_detector_predictions
def get_detector_predictions(detector_model, img_paths, batch_size, binary_predictions):
    """
...
def main(args):
    ...
    df = get_detector_predictions(detector_model, img_paths, batch_size, df)
